...
df_data = pd.read_csv(r"Zomato-Analysis-with-Python-and-visualization-with-Power-BI\Zamoto raw data\zomato.csv", encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r"Zomato-Analysis-with-Python-and-visualization-with-Power-BI\Zamoto raw data\Country-Code.xlsx")
print(df_country)
